      ...
      <div v-if="!isLoadingNews" class="news">
        ...
        <div class="news-body">
          <div class="news-body-list">
            <nuxt-link :to="'/news/' + item.id" class="news-body-list__item" v-for="item in news" :key="item.id">
              <NewsItem :title="item.title" :body="item.body" :created_at="item.created_at" :banner="item.banner" />
            </nuxt-link>
          </div>
        </div>
      </div>
